...
This document will hopefully help you contribute to billetsys.
...
All contributions to billetsys are licensed under the [Eclipse Public License - v2.0](https://www.eclipse.org/legal/epl-2.0/).
...
Don't forget to indicate your billetsys version.
...
You can discuss bug reports, enhancements and features in our [forum](https://github.com/mnemosyne-systems/billetsys/discussions).
...
```
git clone git@github.com:yourname/billetsys.git
cd billetsys
