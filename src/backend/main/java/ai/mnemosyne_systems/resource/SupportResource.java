...
public class SupportResource {
    ...
    public Response createSupportUser(@FormParam("name") String name, @FormParam("fullName") String fullName,
        ...
        eventService.record(newUser.id, ai.mnemosyne_systems.model.event.EventConstants.USER_CREATED, company.id,
                currentUser.get().id, "User created");
    ...
    @Path("/externals")
    @Transactional
    public Response createSupportExternalUser(@FormParam("name") String name, @FormParam("fullName") String fullName,
            @FormParam("email") String email, @FormParam("social") String social,
            @FormParam("phoneNumber") String phoneNumber, @FormParam("phoneExtension") String phoneExtension,
        ...
        return externalUserResource.createExternalUser("support", name, fullName, email, social, phoneNumber,
    ...
    @Path("/externals/{id}")
    @Transactional
    public Response updateSupportExternalUser(@PathParam("id") Long id, @FormParam("name") String name,
        ...
        return externalUserResource.updateExternalUser("support", id, name, fullName, email, social, phoneNumber,
    ...
    @Transactional
    public Response deleteSupportExternalUser(@PathParam("id") Long id) {
        // See createSupportExternalUser: literal path required so support requests reach the shared implementation.
        return externalUserResource.deleteExternalUser("support", id);
    }
