...
class TAMAccessTest extends AccessTestSupport {
    ...
    void tamCanToggleAssignedUserActiveStatus() {
        ensureUser("tam1", "tam1@mnemosyne-systems.ai", User.TYPE_TAM);
        ensureUser("tam-toggle-target", "tam-toggle-target@mnemosyne-systems.ai", User.TYPE_USER);
    ...
    void tamCannotTogglePrivilegedAccount() {
        ensureUser("tam1", "tam1@mnemosyne-systems.ai", User.TYPE_TAM);
        ensureUser("tam-priv-peer", "tam-priv-peer@mnemosyne-systems.ai", User.TYPE_TAM);
        Long companyId = ensureCompany("TAM Toggle Co");
    ...
    void tamCannotToggleUserOutsideAssignedCompany() {
        ensureUser("tam1", "tam1@mnemosyne-systems.ai", User.TYPE_TAM);
        ensureUser("tam-outsider", "tam-outsider@mnemosyne-systems.ai", User.TYPE_USER);
        Long companyId = ensureCompany("TAM Toggle Co");
        ensureCompanyUsers(companyId, "tam1@mnemosyne-systems.ai");
    ...
    void tamToggleRequiresActiveParam() {
        ensureUser("tam1", "tam1@mnemosyne-systems.ai", User.TYPE_TAM);
        ensureUser("tam-param-target", "tam-param-target@mnemosyne-systems.ai", User.TYPE_USER);
        Long companyId = ensureCompany("TAM Toggle Co");
        ...
        RestAssured.given().redirects().follow(false).contentType(ContentType.URLENC)
                .post("/api/tam/users/" + target.id + "/active").then().statusCode(400);
        Assertions.assertTrue(refreshedUser(target.id).active);
    }
