...
class AdminAccessTest extends AccessTestSupport {
    ...
    void adminCanToggleUserActiveStatus() {
        ensureUser("admin", "admin@mnemosyne-systems.ai", User.TYPE_ADMIN);
        ensureUser("toggle-target", "toggle-target@mnemosyne-systems.ai", User.TYPE_USER);
        ...
        RestAssured.given().get("/api/admin/users/" + target.id).then().statusCode(200).body("active",
    ...
    void adminToggleLogsDedicatedActivationEvents() {
        ensureUser("admin", "admin@mnemosyne-systems.ai", User.TYPE_ADMIN);
        ensureUser("event-toggle-target", "event-toggle-target@mnemosyne-systems.ai", User.TYPE_USER);
    ...
    void adminToggleRequiresActiveParam() {
        ensureUser("admin", "admin@mnemosyne-systems.ai", User.TYPE_ADMIN);
        ensureUser("toggle-param-target", "toggle-param-target@mnemosyne-systems.ai", User.TYPE_USER);
        ...
        RestAssured.given().redirects().follow(false).contentType(ContentType.URLENC)
                .post("/api/admin/users/" + target.id + "/active").then().statusCode(400);
    ...
    void adminCanToggleAnyUserType() {
        ensureUser("admin", "admin@mnemosyne-systems.ai", User.TYPE_ADMIN);
        ensureUser("toggle-support", "toggle-support@mnemosyne-systems.ai", User.TYPE_SUPPORT);
    ...
    void adminCanUpdateActiveStatusViaUserForm() {
        ensureUser("admin", "admin@mnemosyne-systems.ai", User.TYPE_ADMIN);
        ensureUser("form-toggle-target", "form-toggle-target@mnemosyne-systems.ai", User.TYPE_USER);
        ...
        RestAssured.given().redirects().follow(false).contentType(ContentType.URLENC)
                .formParam("name", "form-toggle-target").formParam("email", "form-toggle-target@mnemosyne-systems.ai")
                .formParam("type", User.TYPE_USER).formParam("active", "false").post("/user/" + target.id).then()
                .statusCode(303);
        Assertions.assertFalse(refreshedUser(target.id).active);

        RestAssured.given().redirects().follow(false).contentType(ContentType.URLENC)
                .formParam("name", "form-toggle-target").formParam("email", "form-toggle-target@mnemosyne-systems.ai")
                .formParam("type", User.TYPE_USER).formParam("active", "true").post("/user/" + target.id).then()
                .statusCode(303);
        Assertions.assertTrue(refreshedUser(target.id).active);

        RestAssured.given().redirects().follow(false).contentType(ContentType.URLENC).formParam("name", "admin")
