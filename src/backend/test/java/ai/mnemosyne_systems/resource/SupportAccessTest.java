...
class SupportAccessTest extends AccessTestSupport {
    ...
    void supportCanToggleUserActiveStatus() {
        ensureUser("support1", "support1@mnemosyne-systems.ai", User.TYPE_SUPPORT);
        ensureUser("support-toggle-target", "support-toggle-target@mnemosyne-systems.ai", User.TYPE_USER);
        ...
        RestAssured.given().get("/api/support/user-profiles/" + target.id).then().statusCode(200).body("active",
    ...
    void supportCannotTogglePrivilegedAccount() {
        ensureUser("support1", "support1@mnemosyne-systems.ai", User.TYPE_SUPPORT);
        ensureUser("support-priv-target", "support-priv-target@mnemosyne-systems.ai", User.TYPE_ADMIN);
    ...
    void supportToggleRequiresActiveParam() {
        ensureUser("support1", "support1@mnemosyne-systems.ai", User.TYPE_SUPPORT);
        ensureUser("support-param-target", "support-param-target@mnemosyne-systems.ai", User.TYPE_USER);
        ...
        RestAssured.given().redirects().follow(false).contentType(ContentType.URLENC)
                .post("/api/support/users/" + target.id + "/active").then().statusCode(400);
        Assertions.assertTrue(refreshedUser(target.id).active);
    }
    ...
    void supportCanUpdateExternalUserActiveStatus() {
        ensureUser("support1", "support1@mnemosyne-systems.ai", User.TYPE_SUPPORT);
        ensureUser("support-ext-target", "support-ext-target@mnemosyne-systems.ai", User.TYPE_EXTERNAL);
        ...
        RestAssured.given().get("/api/support/externals/" + target.id).then().statusCode(200).body("active",
                Matchers.equalTo(true));
        RestAssured.given().redirects().follow(false).contentType(ContentType.URLENC)
                .formParam("fullName", "External Target").formParam("email", "support-ext-target@mnemosyne-systems.ai")
                .formParam("active", "false").post("/support/externals/" + target.id).then().statusCode(303);
        ...
        RestAssured.given().redirects().follow(false).contentType(ContentType.URLENC)
                .formParam("fullName", "External Target").formParam("email", "support-ext-target@mnemosyne-systems.ai")
                .formParam("active", "true").post("/support/externals/" + target.id).then().statusCode(303);
        Assertions.assertTrue(refreshedUser(target.id).active);
    }
